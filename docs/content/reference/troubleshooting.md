...
Most of these come down to network reality or how phoronix serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

phoronix rate-limits like any public site. phoronix already paces
...
Where a surface is gated, phoronix reads a cookie or token you supply
...
`phoronix`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what phoronix actually did
